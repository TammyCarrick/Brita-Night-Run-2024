...
# get_results("C:\\Users\\tammy\\Desktop\\Webscraping\\race stats\\html_files\\toronto10k_pg1.html",
#             "C:\\Users\\tammy\\Desktop\\Webscraping\\race stats\\data_csv\\" + "test.csv")

for i in range(len(TORONTO_FILES)):
    get_results(TORONTO_FILES[i], new_file_paths[i])
